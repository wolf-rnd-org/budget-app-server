...
console.log("Fetching expenses for programId:", programId, "escaped as:", esc);
...
// New query function that implements auth scope, filtering, search, sorting and pagination
